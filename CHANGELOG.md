...
- Updated the AssemblyAI transcription model identifier to `assemblyai.universal-3-5-pro`.

## [2.1.0] - 2026-06-20

### Changed

- Regenerated SDK from the latest Speechall OpenAPI document, updating supported transcription model identifiers.
- Corrected package-lock root metadata to match `@speechall/sdk`.
