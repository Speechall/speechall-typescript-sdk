...
export interface TranscriptionOptions {
    ...
    /**
     * An array of replacement rules to be applied directly to this transcription request, in order. This allows defining rules inline instead of using a pre-saved `ruleset_id`.
     * @type {Array<ReplacementRule>}
     * @memberof TranscriptionOptions
     */
...
export const SpeechToTextApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {TranscriptionOptions} transcriptionOptions JSON object containing the URL of the audio file and the desired transcription options.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        transcribeRemote: async (transcriptionOptions: TranscriptionOptions, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'transcriptionOptions' is not null or undefined
...
export const SpeechToTextApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async transcribeRemote(transcriptionOptions: TranscriptionOptions, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TranscriptionResponse>> {
...
export const SpeechToTextApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        transcribeRemote(transcriptionOptions: TranscriptionOptions, options?: RawAxiosRequestConfig): AxiosPromise<TranscriptionResponse> {
...
export class SpeechToTextApi extends BaseAPI {
     ...
     * @memberof SpeechToTextApi
     */
    public transcribeRemote(transcriptionOptions: TranscriptionOptions, options?: RawAxiosRequestConfig) {
